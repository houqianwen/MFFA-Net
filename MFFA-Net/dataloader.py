...
class Trainteacher(data.Dataset):
    def __init__(self, dataroot, phase, finesize):
        ...
        self.dir_A = os.path.join(self.root, self.phase + '/clear')
        self.dir_B = os.path.join(self.root, self.phase + '/clear_label')
    ...
    def __getitem__(self, index):
        ...
        # resize
        resized_a = A.resize((256, 256), Image.ANTIALIAS)
        resized_b = B.resize((256, 256), Image.ANTIALIAS)
        ...
        name = os.path.basename(self.A_paths[index])
...
class TrainLabeled(data.Dataset):
    def __init__(self, dataroot, phase, finesize):
        ...
        self.dir_A = os.path.join(self.root, self.phase + '/haze')
        self.dir_B = os.path.join(self.root, self.phase + '/clear')
